...
<body itemscope itemtype="http://schema.org/WebPage" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="information" class="container-fluid content-section text-center">
        <div class="row">
			<?php if ($this->countModules('grayscale_information')) : ?>
					<jdoc:include type="modules" name="grayscale_information" style="none" />
			<?php endif; ?>
        </div>
    </section>
    <section id="services" class="content-section text-center">
        <div class="gray-section">
            <div class="container-fluid">
			<?php if ($this->countModules('grayscale_service')) : ?>
    ...
    <section id="consumer" class="container content-section text-center">
			<?php if ($this->countModules('grayscale_consumer')) : ?>
					<jdoc:include type="modules" name="grayscale_consumer" style="none" />
			<?php endif; ?>
    </section>
    <section class="content-section text-center">
        <div class="gray-section">
            <div class="container-fluid">
			<?php if ($this->countModules('grayscale_contribute')) : ?>
					<jdoc:include type="modules" name="grayscale_contribute" style="none" />
			<?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <section class="container content-section text-center">
        <div class="row">
			<?php if ($this->countModules('grayscale_confiances')) : ?>
					<jdoc:include type="modules" name="grayscale_confiances" style="none" />
			<?php endif; ?>
        </div>
    </section>
