...
<div class="rokajaxsearch <?php echo $params->get('moduleclass_sfx'); ?>">
	...
	<label for="searchword">Rechercher une entreprise</label>
		<input id="roksearch_search_str" title="<?php echo JText::_('LOCAL_SEARCH'); ?>" name="searchword" type="text" class="inputbox roksearch_search_str" />
	</div>
